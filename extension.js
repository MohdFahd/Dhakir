...
const messages = [
  ...
  "اللهم اجعل في قلبي نورًا، وفي لساني نورًا، واجعل في سمعي نورًا، وفي بصري نورًا، واجعل من خلفي نورًا، ومن أمامي نورًا، واجعل من فوقي نورًا، ومن تحتي نورًا.",
  "اللهم إني أسألك العافية في الدنيا والآخرة، وأسألك الهدى والتقى والعفاف والغنى.",
  ...
  "اللهم إني أعوذ بك من شر كل دابة أنت آخذ بناصيتها، إن ربي على صراط مستقيم.",
  "ربنا لا تزغ قلوبنا بعد إذ هديتنا وهب لنا من لدنك رحمة، إنك أنت الوهاب.",
  "اللهم ارزقنا حسن الخاتمة، وأعذنا من سوء الخاتمة.",
];
  ...
  const disposable = vscode.commands.registerCommand(
    ...
    function () {
      vscode.window.showInformationMessage(
        "Auto notifications are set to every 30 seconds."
      );
    }
  );
